...
export interface Speaker {
  name: string
  url: string
  /** 2-letter initials for the avatar chip. */
  initials: string
}
...
export interface PartnerEvent {
  ...
  /** Speakers shown as chips under the title. */
  speakers: Speaker[]
}
...
const TOMEK: Speaker = {
  name: 'Tomek Lelek',
  url: 'https://www.linkedin.com/in/tomasz-%C5%82elek-23341174/',
  initials: 'TL',
}
...
export const PARTNER_EVENTS: PartnerEvent[] = [
  ...
  },
  {
    ...
    blurb:
      'Artur Skowroński and Tomek Lelek on what they learned shipping AI-assisted code for a year across enterprise clients — and why they bet on the patterns that survive the next model drop. 30 demo copies of the Manning book given away on-site.',
